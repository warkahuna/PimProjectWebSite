...
public addToCompare(product:Product){
    let message, status;
    if(this.Data.compareList.filter(item=>item.name == product.name)[this.Data.index]){
...
public addToWishList(product:Product){
    let message, status;
    if(this.Data.wishList.filter(item=>item.name == product.name)[this.Data.index]){
...
public addToCart(product:Product){
    ...
    if(this.Data.cartList.filter(item=>item.name == product.name)[ this.Data.index ]){
        let item = this.Data.cartList.filter(item=>item.name == product.name)[ this.Data.index ];
...
public resetProductCartCount(product:Product){
    product.cartCount = 0;
    let compareProduct = this.Data.compareList.filter(item=>item.name == product.name)[this.Data.index];
    if(compareProduct){
        compareProduct.cartCount = 0;
    };
    let wishProduct = this.Data.wishList.filter(item=>item.name == product.name)[this.Data.index];
    if(wishProduct){
